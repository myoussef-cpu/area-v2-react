...
export function ColorBadge({ u }: AccessoryProps): JSX.Element {
  return (
...
export function TinyBow({ u }: AccessoryProps): JSX.Element {
  return (
...
export function Bandana({ u }: AccessoryProps): JSX.Element {
  return (
...
export function StarMark({ u }: AccessoryProps): JSX.Element {
  return (
...
export function FlowerMark({ u }: AccessoryProps): JSX.Element {
  return (
...
export function LeafMark({ u }: AccessoryProps): JSX.Element {
  return (
...
export function HeartMark({ u }: AccessoryProps): JSX.Element {
  return (
...
export function Ribbon({ u }: AccessoryProps): JSX.Element {
  return (
...
export function BlushMarks({ u }: AccessoryProps): JSX.Element {
  return (
...
export function Antenna({ u }: AccessoryProps): JSX.Element {
  return (
...
export interface AccessoryIdProps {
  id: number
  u: number
}

export function Accessory({ id, u }: AccessoryIdProps): JSX.Element {
